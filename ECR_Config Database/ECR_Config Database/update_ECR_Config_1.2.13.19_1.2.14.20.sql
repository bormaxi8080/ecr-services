...
select
    @OldVersion = N'1.2.13.19'
    , @NewVersion = N'1.2.14.20'
    , @Description = left(N'Исправление багов с хранимках, формирующих отчет', 255);
...
PRINT N'Altering [ecr].[GetContentCountByTypeAndTime]'
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
