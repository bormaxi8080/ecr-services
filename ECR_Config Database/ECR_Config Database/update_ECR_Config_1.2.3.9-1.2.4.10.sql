...
select
    @OldVersion = N'1.2.3.9'
    , @NewVersion = N'1.2.4.10'
    , @Description = left(N'Изменения в хранимой процедуре ecr.MarkProcessedPackage', 255);
...
GO
/****** Object:  StoredProcedure [ecr].[MarkProcessedPackage]    Script Date: 05/27/2009 13:22:43 ******/
...
/****** Object:  StoredProcedure [ecr].[MarkProcessedPackage]    Script Date: 05/27/2009 13:23:42 ******/
SET ANSI_NULLS ON
GO
IF @@ERROR<>0 AND @@TRANCOUNT>0 ROLLBACK TRANSACTION
GO
